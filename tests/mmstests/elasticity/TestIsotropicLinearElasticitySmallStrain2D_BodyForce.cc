...
namespace pylith {
    namespace mmstests {
        class TestIsotropicLinearElasticitySmallStrain2D_BodyForce;

        class TestIsotropicLinearElasticitySmallStrain2D_BodyForce_TriP2;
        class TestIsotropicLinearElasticitySmallStrain2D_BodyForce_TriP3;
        class TestIsotropicLinearElasticitySmallStrain2D_BodyForce_TriP4;

        class TestIsotropicLinearElasticitySmallStrain2D_BodyForce_QuadQ2;
        class TestIsotropicLinearElasticitySmallStrain2D_BodyForce_QuadQ3;
        class TestIsotropicLinearElasticitySmallStrain2D_BodyForce_QuadQ4;

    } // materials
} // pylith

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce :
...
protected:
    ...
    void setUp(void) {
        ...
        GenericComponent::setName("TestIsotropicLinearElasticitySmallStrain2D_BodyForce");
...
}; // TestIsotropicLinearElasticitySmallStrain2D_BodyForce
const double pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce::LENGTHSCALE = 1.0e+3;
const double pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce::TIMESCALE = 2.0;
const double pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce::PRESSURESCALE = 2.25e+10;
const double pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce::BODYFORCE = 5.0e+3;
const double pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce::XMAX = 4.0e+3;

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce_TriP2 :
    public pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticitySmallStrain2D_BodyForce_TriP2,
                           TestIsotropicLinearElasticitySmallStrain);
    CPPUNIT_TEST_SUITE_END();

    void setUp(void) {
        TestIsotropicLinearElasticitySmallStrain2D_BodyForce::setUp();
        CPPUNIT_ASSERT(_data);
...
}; // TestIsotropicLinearElasticitySmallStrain2D_BodyForce_TriP2
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce_TriP2);

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce_TriP3 :
    public pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticitySmallStrain2D_BodyForce_TriP3,
                           TestIsotropicLinearElasticitySmallStrain);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestIsotropicLinearElasticitySmallStrain2D_BodyForce_TriP3
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce_TriP3);

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce_QuadQ2 :
    public pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticitySmallStrain2D_BodyForce_QuadQ2,  TestIsotropicLinearElasticitySmallStrain);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestIsotropicLinearElasticitySmallStrain2D_BodyForce_QuadQ2
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce_QuadQ2);

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce_QuadQ3 :
    public pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticitySmallStrain2D_BodyForce_QuadQ3,  TestIsotropicLinearElasticitySmallStrain);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestIsotropicLinearElasticitySmallStrain2D_BodyForce_QuadQ3
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearElasticitySmallStrain2D_BodyForce_QuadQ3);
